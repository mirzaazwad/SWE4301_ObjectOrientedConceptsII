...
public class BottlesTest {
    ...
    @Test
    void verse150() throws Exception{
        Exception thrown = assertThrows(Exception.class, () -> {
            BottleProblem bottleProblem=new BottleProblem();
            bottleProblem.verse(150);
        });

        assertEquals(thrown.getMessage(),"Number Of Bottles greater than 99");
    }

    @Test
    void verseNegative() throws Exception{
        Exception thrown = assertThrows(Exception.class, () -> {
            BottleProblem bottleProblem=new BottleProblem();
            bottleProblem.verse(-2);
        });

        assertEquals(thrown.getMessage(),"Number of Bottles less than 0");
    }

    @Test
    void FullSong() throws Exception{
        String expected="99 bottles of beer on the wall, 99 bottles of beer.\n" +
                ...
                "No more bottles of beer on the wall, no more bottles of beer.\n" +
                "Go to the store and buy some more, 99 bottles of beer on the wall.\n";
        assertEquals(expected,new BottleProblem().verse(99));
    }

    @Test
    public void Range10to2() throws Exception{
        String expected="10 bottles of beer on the wall, 10 bottles of beer.\n" +
                ...
                "2 bottles of beer on the wall, 2 bottles of beer.\n" +
                "Take one down and pass it around, 1 bottle of beer on the wall.\n";
        assertEquals(expected,new BottleProblem().verseRange(10,2));
    }
    ...
    public void RangeExceptionTest(){
        Exception thrown = assertThrows(Exception.class, () -> {
            BottleProblem bottleProblem=new BottleProblem();
            bottleProblem.verseRange(10,20);
        });

        assertEquals(thrown.getMessage(),"Range is invalid");
    }
}
